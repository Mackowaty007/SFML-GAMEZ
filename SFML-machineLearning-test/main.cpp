...
int main()
{
    ...
    while (app.isOpen())
    {
        ...
        //check collisions
        if(obstacle1 + 100 > HEIGHT - 100 && obstacle1 < HEIGHT && carPos == -1 || obstacle2 + 100 > HEIGHT - 100 && obstacle2 < HEIGHT && carPos == 0 || obstacle3 + 100 > HEIGHT - 100 && obstacle3 < HEIGHT && carPos == 1){
            score ++;
        }
        ...
        car.setPosition((carPos+1)/3*WIDTH,HEIGHT - 100);
        ...
        neuron.setFillColor(sf::Color(200,200,200));
        window.draw(neuron);
